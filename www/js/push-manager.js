...
function pushAddedNode(data){
	...
	var pushedNode=new Node(data.nodeid,data.name,data.basevalue,data.computedvalue,data.type,data.typevalue,data.state,data.attachment,{},{},data.x,data.y,data.createdby,data.modifiedby);
...
function pushNodeEdit(data){
	...
	nodeList[data.nodeid].editInfo(decodeURIComponent(data.name), decodeURIComponent(data.basevalue), decodeURIComponent(data.computedvalue), decodeURIComponent(data.typevalue), decodeURIComponent(data.state), decodeURIComponent(data.attachment), decodeURIComponent(data.modifiedby));
